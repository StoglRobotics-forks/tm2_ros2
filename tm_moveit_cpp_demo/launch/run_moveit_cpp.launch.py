...
def generate_launch_description():
    ...
    # Use URDF file: tm12s-nominal.urdf to do moveit demo
    # robot_description_config = load_file('tm_description', 'urdf/tm12s-nominal.urdf')
    ...
    # Kinematics
    kinematics_yaml = load_yaml('tm12s_moveit_config', 'config/kinematics.yaml')
